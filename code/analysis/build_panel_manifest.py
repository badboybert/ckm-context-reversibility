...
PANELS = [
 ...
 dict(file='data/proteome/reversal_emperor.tsv',         layer='proteome', platform='Olink',    intervention='SGLT2i',    tissue='plasma', n_pairs=1134, bmi_axis='goudswaard_ST5_INTERVAL', base_sd='proxy_ukbppp', note='treatment-effect not paired'),
 ...
 # GEO expansion (wf_f16d1c1c-f89, verified). GSE95640 dropped: build failed + redundant with GSE141221 (SAME DiOGenes cohort).
 ...
 # MAP-expansion panels (wf_75c7dd8f, verified). base_sd='pending' => score/signature/cross-context only (NOT persistence/determinant until base_sd recomputed).
 ...
 # MAP-exhaustion wave (wf_6477c2d0, verified). GSE117070 EXCLUDED (batch-confounded signs). base_sd computed only for muscle GSE83352.
 ...
 dict(file='data/transcriptome/gse107894_adipose_metformin_reversal_table.tsv', layer='transcriptome', platform='array', intervention='metformin', tissue='SAT_adipose', n_pairs=None, bmi_axis='acquire', base_sd='pending', role='context-durability', status='ANALYZED', note='adipose metformin context'),
 dict(file='data/transcriptome/gse161643_muscle_bariatric_reversal_table.tsv',  layer='transcriptome', platform='RNAseq', intervention='bariatric', tissue='skeletal_muscle', n_pairs=None, bmi_axis='acquire', base_sd='pending', role='context-durability', status='ANALYZED', note='muscle bariatric context'),
 dict(file='data/transcriptome/gse224310_adipose_exercise_reversal_table.tsv',  layer='transcriptome', platform='RNAseq', intervention='exercise', tissue='SAT_adipose', n_pairs=None, bmi_axis='acquire', base_sd='pending', role='context-durability', status='ANALYZED', note='adipose exercise context'),
 dict(file='data/transcriptome/gse310742_blood_glp1ra_reversal_table.tsv',      layer='transcriptome', platform='RNAseq', intervention='GLP1RA', tissue='whole_blood', n_pairs=None, bmi_axis='acquire', base_sd='pending', role='context-durability', status='ANALYZED', note='blood GLP1RA context'),
 ...
 # --- transcriptome batch-confounded EXCLUSION (wf_6477c2d0) ---
 dict(file='data/transcriptome/gse117070_muscle_exercise_reversal_table.tsv',   layer='transcriptome', platform='array', intervention='exercise', tissue='skeletal_muscle', n_pairs=None, bmi_axis='acquire', base_sd='pending', role='context-durability', status='EXCLUDED', note='EXCLUDED batch-inverted signs (wf_6477c2d0)'),
 # --- cross-layer panels (same GSE measured across layers; analyzed for cross-layer concordance) ---
 dict(file='data/transcriptome/gse60655_muscle_expression_reversal_table.tsv',  layer='transcriptome', platform='array', intervention='exercise', tissue='skeletal_muscle', n_pairs=None, bmi_axis='acquire', base_sd='pending', role='cross-layer', status='ANALYZED', note='GSE60655 expression arm (cross-layer w/ methylation)'),
 ...
 dict(file='data/methylation/gse60655_muscle_exercise_reversal.tsv',   layer='methylation', platform='450K', intervention='exercise', tissue='skeletal_muscle', n_pairs=None, bmi_axis='acquire', base_sd='measured', role='cross-layer', status='ANALYZED', note='GSE60655 methylation arm (cross-layer w/ expression)'),
