...
PANELS = [
 ...
 dict(file='data/transcriptome/gse60655_muscle_expression_reversal_table.tsv',  layer='transcriptome', platform='array', intervention='exercise', tissue='skeletal_muscle', n_pairs=None, bmi_axis='acquire', base_sd='pending', role='cross-layer', status='ANALYZED', note='GSE60590 expression arm; same endurance-training study as the GSE60655 methylation panel (cross-layer)'),
